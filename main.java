...
public class Main {
    ...
    public static String DataAdmissao() {
        ...
        int j = 0;
        while(x==0) {
            System.out.println("Digite o dia da sua admissão (números entre 1 e 31)");
            dia = scan.nextInt();
            x = 1;
            if (dia <= 0 || dia > 31)
                x = 0;
        ...
        while(y==0) {
            System.out.println("Digite o mês da sua admissão (números entre 1 e 12)");
            mes = scan.nextInt();
            y = 1;
            if(mes<1 || mes>12)
                y = 0;
        ...
        while(j==0) {
            System.out.println("Digite o ano da sua admissão (números entre 2016 e 2023)");
            ano = scan.nextInt();
            j = 1;
    ...
    public static String MesReferencia(){
        ...
        String mes = "";
        while(x==0) {
            System.out.println("Qual é o mês da folha de pagamento? (Responda em números de 1 a 12)");
